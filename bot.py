...
async def telegraph(bot, message):
    ...
    if message.sticker:
        ...
        img.save(f'{DOWNLOAD_DIRECTORY}/MAMBA_STAR-{message.from_user.id}.png', 'png')
        os.remove(down_loc)
        down_loc = f'{DOWNLOAD_DIRECTORY}/MAMBA)STAR-{message.from_user.id}.png'
